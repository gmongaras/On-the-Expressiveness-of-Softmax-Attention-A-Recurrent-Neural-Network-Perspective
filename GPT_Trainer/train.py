...
def main():
    ...
    batch_size=35 # Total batch size across all gpus (that is, a batch size of 128 with 2 gpus has a gpu batch size of 64)
    learning_rate=1e-4
    warmup_steps=10_000
    num_steps=1_000_000
    num_steps_early_stop=100_000
    dev="gpu"
    wandb_name="fineweb_gated_softmax_plusplus_35bs_2gpu_1024seqlenV2"
    log_steps=10
    use_amp=True
    ...
    clipping_value=None
    weight_decay=0.01
    model_save_path = "models/fineweb_gated_softmax_plusplus_35bs_2gpu_1024seqlenV2"
    ...
    checkpoint_path = "models/fineweb_gated_softmax_plusplus_35bs_2gpu_1024seqlenV2/"
