...
class Mamba2Mixer(nn.Module):
    ...
    def __init__(self, config: Mamba2Config, layer_idx: int):
        ...
        self.mask = torch.tril(torch.ones(16, 32, 1023, 1023)).to(self.out_proj.weight.device) == 0
    ...
    def torch_forward(self, input_states, cache_params: Optional[Mamba2Cache]=None, cache_position:Optional[torch.LongTensor]=None, attention_mask: Optional[torch.Tensor]=None):
        ...
        # Output projection
        out = M @ hidden_states.transpose(1, 2)

        # Add residual
        y = out.transpose(1, 2) + D_residual[:, :seq_len, :, :]
...
class Mamba2Block_SM(nn.Module):
...
if __name__=="__main__":
    ...
    inp = torch.randn(4, 1024, config.hidden_size).cuda()
    with torch.no_grad():
